...
## Правила генерации (NanoBanana Pro / Seedream)

**Основной инструмент:** NanoBanana Pro (через Syntx)
**Альтернатива:** Seedream 4 — использовать параллельно, сравнивать результат
...
5. Белый фон модель игнорирует — использовать зимний/нейтральный фон
...
- NanoBanana Pro — старт, основная генерация, ретушь
- Seedream — альтернативный прогон, сравнение качества
- Лучший результат → записать инструмент в `assets/registry.md`
